...
function exibeCartaJogador() {
    ...
    for (var atributo in cartaJogador.atributos) {
        opcoesTexto += `<input type='radio' name='atributo' value='${atributo}'> ${atributo} ${cartaJogador.atributos[atributo]} / 100 <br> `
    }
...
function exibeCartaMaquina() {
    ...
    for (var atributo in cartaMaquina.atributos) {
        opcoesTexto += `<p type='text' name='atributo' value='${atributo}'> ${atributo} ${cartaMaquina.atributos[atributo]} / 100 <br>`
    }
